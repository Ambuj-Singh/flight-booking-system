...
const Payment = () => {
    ...
    console.log(state.passenger)

    const data = state.passenger

    function handleSavePassenger(e){
        fetch("http://localhost:9090/api/flyaway/passenger/save",{
            method:"POST",
            headers:{"Content-Type":"application/json"},
            body:JSON.stringify(state.passenger)
    ...
    return(
        ...
        <div class=" min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10 pt-16">
        <div class=" mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" >
            <div class=" pt-1 pb-5">
                <div class="bg-indigo-500 text-white overflow-hidden rounded-full w-20 h-20 -mt-16 mx-auto shadow-lg flex justify-center items-center">
                    <Icon icon="mdi-credit-card-outline" className='text-3xl'></Icon>
                </div>
            </div>
            <div class="mb-10">
            ...
            <div>
                <button onClick={handleSavePassenger} class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">
                    <Icon icon='mdi-lock-outline' className='text-xl ml-20 -mb-5'/> PAY NOW</button>
            </div>
        </div>
    </div>
